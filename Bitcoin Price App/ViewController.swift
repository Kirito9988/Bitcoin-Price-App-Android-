...
//  Bitcoin Price App
//
//  Created by Tarun Thakur on 2023-03-28.
//
   ...
   func getDefaultPrices(){
    ...
    func getPrice() {
     if let url =  URL(string:
                "https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=USD,JPY,EUR&api_key=468fa91857d8a989f2260e6aaee22a74f8ae8f3766d44b9bbaa121dda8926fb4")
        {
